...
export const PeoplePage = () => {
    ...
    return (
        <>
            ...
            <Box sx={{display:'flex', flexDirection: 'column', alignItems:'center', position: 'absolute', top:'150px', zIndex: 1000}}>
                <Box sx={{display: 'flex', flexDirection: 'column', width: {xs: '60%', lg: '500px'}, boxShadow: '2px 2px 10px black'}}>
                    ...
                    <Typography variant="h4" sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'center',bgcolor: selectedColor, color: 'white', fontWeight: '900', pr: 1, py: 1}}>
                        NOMBRE ARTISTA
                    </Typography>
                ...
                <Typography sx={{ color: darkMode ? 'white' : 'black', mx: 15, mt: 10,  mb: 3, textAlign: 'justify', minWidth: {md:'350px', lg: '500px'}}}>
